...
async function submit() {
    ...
    try {
        ...
        const response = await fetch('/api/v4/ad-submissions', {
            method: 'POST',
            headers: { Accept: 'application/json', 'X-Client-Platform': 'web', 'X-Client-Version': '1.0' },
            body,
        });
...
<template>
    <main class="ad-public-page">
        ...
        <section v-if="result" class="ad-success section-pad">
        ...
        <section v-else class="ad-form-layout section-pad">
            <aside>
                ...
                <ol><li><b>01</b>Campaign details fill up</li><li><b>02</b>Media leh link upload</li><li><b>03</b>Admin review</li><li><b>04</b>Approved ad publish</li></ol>
                <p>Approval hma chuan ad chu Zo Stream apps-ah a lang lo vang.</p>
            </aside>
            <form class="ad-submit-form" @submit.prevent="submit">
                ...
                <label class="ad-terms"><input v-model="form.terms_accepted" type="checkbox" required><span>Ka submit media leh link te hman phalna ka nei a, Zo Stream review policy ka pawm.</span></label>
