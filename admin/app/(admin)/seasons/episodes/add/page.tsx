...
import { AddEpisodeForm } from "@/app/features/seasons/components/add-episode-form";
  ...
  return (
    <main className="flex min-h-svh flex-1 flex-col px-3 py-1 text-slate-900 lg:h-svh lg:min-h-0 lg:overflow-hidden lg:px-2 lg:py-1 dark:text-white">
      <div className="flex w-full flex-1 flex-col lg:min-h-0">
        <AdminPageHeader title="Add episode" initialMode={initialMode} />
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Link the episode to a season ID, add a thumbnail and release
                  details, then save it as a draft or publish it.
                </p>
              </div>
            </div>
          </section>
