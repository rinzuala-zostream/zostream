...
import { AddMovieForm } from "@/app/features/movies/components/add-movie-form";
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                ...
                <h2 className="mt-2 text-2xl font-bold tracking-tight text-slate-950 sm:text-3xl dark:text-white">
                  Prepare a movie with artwork, stream links, pricing, and shelf
                  flags.
                </h2>
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Only the title is required. Keep it as Draft while collecting
                  assets, then publish when the movie is ready for viewers.
                </p>
              </div>
            </div>
          </section>
