    ...
    public function getAds(Request $request)
    {
        ...
        try {
            ...
            $filtered = $ads->filter(function ($ad) {
                ...
                return Carbon::now()->between($createDate, $endDate);
            });

            return $this->success("Ads fetched successfully", array_values($filtered->toArray()));
        } catch (Exception $e) {
            return $this->error("Failed to fetch ads", 500, $e->getMessage());
        }
    }
